        ...
        <div class="col-md-12">
          <div class="card ">
            ...
            <div class="card-body ">
              ...
              <div class="row">
                <div class="col-2">
                  <form action="/Approved-Surat-permohonan-logistik-Rektor-{{ $suratlogistik -> id }}" method="POST">
                    @csrf
                    @method('PUT')
                ...
                <div class="col">
                  <form action="/Reject-Surat-permohonan-logistik-Rektor-{{ $suratlogistik -> id }}" method="POST">
                    @csrf
                    @method('PUT')
