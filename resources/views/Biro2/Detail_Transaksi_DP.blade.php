        ...
        <div class="col-md-12">
          <div class="card ">
            ...
            <div class="card-body ">
              ...
              <form action="/proses-DP-pembayaran-{{ $transaksilogistik -> id }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mt-2">
                  <div class="row">
                    <div class="col">
                      ...
                      <input type="text" name="pembayaran_dp"  class="form-control" placeholder="Nominal Bayar">
                      <input type="text" name="pembayaran_dp_old"  class="form-control" placeholder="Nominal Bayar" value="{{$transaksilogistik -> pembayaran_dp }}" hidden>
                      <input type="text" name="status_dp"  class="form-control" placeholder="Nominal Bayar" value="On Going" hidden>
                      <input type="text" name="status_lunas"  class="form-control" placeholder="Nominal Bayar" value="On Prosses" hidden>
                    </div>
                    <div class="col">
                      <label class="text-dark">Bukti Payment</label>
                      <input type="file" name="bukti_dp"  class="form-control" title="Bukti Pembayaran">
                    </div>
                  </div>
                </div>
